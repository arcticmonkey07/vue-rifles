...
<template>
  ...
  >
    <div class="absolute top-8 left-8 like-wrapper" v-if="onClickFavorite">
      <svg
        v-if="isFavorite"
    ...
    <img :src="img" class="w-full" alt="Rifle" />
    <p>{{ title }}</p>
    <div class="flex justify-between mt-5">
      ...
      <div class="svg-add" v-if="onClickAdd">
        <svg
          v-if="!isAdded"
          @click="onClickAdd"
          class="plus"
...
<style scoped>
.svg-add .plus:hover rect {
  fill: rgb(163, 249, 170);
  stroke: rgb(163, 249, 170);
}
...
.like-wrapper .like:hover rect {
  fill: #fef0f0;
}

.like-wrapper .like rect {
  transition: all 0.3s ease;
}
</style>
